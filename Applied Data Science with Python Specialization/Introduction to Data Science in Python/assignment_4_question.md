...
The following data files are available for this assignment:<br>
    ...
    - From Bureau of Economic Analysis, US Department of Commerce, the GDP over time of the United States in current dollars (use the chained value in 2009 dollars), in quarterly intervals, in the file <b>gdplev.xls</b>. For this assignment, only look at GDP data from the first quarter of 2000 onward.
